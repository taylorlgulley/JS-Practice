...
let spamArray = []
customers.forEach((index) => {
    spamArray.push(index.contacts.email);
})
console.log(spamArray);

//Other way for them to all be seperate emails instead of in groups, when using forEach or map you are already in the array interating through it
// customers.forEach((index) => {
//     return spamArray = spamArray.concat(index.contacts.email);
// })
// console.log(spamArray);